...
// Validate ../../app/api/project/[slug]/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/project/[slug]">> = Specific
  const handler = {} as typeof import("../../app/api/project/[slug]/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
